...
def test_datacraft_token_contract(ethereum_network, ethereum_accounts):
    ...
    balance = datacraft_token_contract.get_balance(from_account)
...
#    tx_hash = datacraft_token_contract.approve_transfer(from_account,  datacraft_token_contract.address, TOKEN_AMOUNT_TO_TRANSFER)
#    receipt = datacraft_token_contract.wait_for_receipt(tx_hash)
    ...
    tx_hash = datacraft_token_contract.transfer(from_account, to_account.address, TOKEN_AMOUNT_TO_TRANSFER)
    receipt = datacraft_token_contract.wait_for_receipt(tx_hash)
